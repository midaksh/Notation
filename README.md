...
1. Marketing landing page with sign-in entry point
2. User authentication (Clerk) and personal workspace
3. Create new pages (`Untitled` by default)
...
10. Inline image upload inside the editor
11. Page emoji icon (add, change, remove)
12. Cover image (upload, change, remove)
...
18. Trash banner on archived pages (restore or delete forever)
19. Publish page to a public read-only link
20. Unpublish and copy share URL
21. Public preview page at `/preview/[documentId]`
22. Light / dark / system theme toggle
